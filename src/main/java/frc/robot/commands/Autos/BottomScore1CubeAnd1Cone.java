...
public class BottomScore1CubeAnd1Cone extends SequentialCommandGroup {
  ...
  public BottomScore1CubeAnd1Cone(Swerve s_Swerve, IntakeSubsystem s_Intake, ArmSubsystem s_Arm, WristSubsystem s_Wrist) {
    ...
    new PathPlannerCommand(s_Swerve, 2, "Back up after cone bottom", true),
      ...
      new PathPlannerCommand(s_Swerve, 2, "Grab cone"),
    ...
    new PathPlannerCommand(s_Swerve, 3, "Score second cone").alongWith(new ShoulderToHome(s_Arm))
    ...
    //new PathPlannerCommand(s_Swerve, 4, "Score cube").alongWith(new ShoulderToHome(s_Arm)).alongWith(new InstantCommand(() -> s_Arm.shoulderReversed *= -1))
